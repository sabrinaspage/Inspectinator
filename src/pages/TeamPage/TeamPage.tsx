...
// "mx-auto d-flex justify-content-center"
  return (
    <div className="mt-5 py-4 mb-5 pb-5">
      ...
      <p className="mt-4 container-fluid font-weight-bold text-center text-muted">We’re a small team that loves to create great experiences and make meaningful connections between builders and customers.</p>
