            ...
            <div className = "row vh-100">
                <div className = "d-flex align-items-md-center col-lg-6 col-sm-12 justify-content-center">
                    <div className="col-md-8 col-lg-6" style={{textAlign: "left"}}>
                        <h2>Sign Up</h2>
                        <p className = "mt-3 fs-6 fst-normal text-black-50">Enter your details below to complete sign up</p>

                        <p className='p-0 pb-1 mt-5 mb-2 fs-8'>Name*</p>
                        <input style = {{borderRadius: '8px'}} type="text" ref = {nameRef} className = "py-2 px-3 form-control" placeholder="Enter your name" />
                        
                        <div className = "p-2"></div>

                        <p className='p-0 pb-1 mb-2 mt-3 fs-8'>Email*</p>
                        <input style = {{borderRadius: '8px'}} type="text" ref = {emailRef} className = "y-2 px-3 form-control" placeholder="Enter your password" />
                        ...
                        <button style = {{borderRadius: '8px'}} className = "btn w-100 btn-dark p-2 mt-4 bg-dark" onClick= {signUpFunc}>Get Started</button>
