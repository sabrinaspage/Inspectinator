...
export default function DocumentPreview() {
  ...
  const fetchData = async () => {
    const response = await fetch(
      "http://localhost:5000/document/data/" + documentId,
      {
        method: "GET",
      }
    );
    ...
    <div className="container-fluid my-5 pt-3 pb-5">
      <div className="container">
          ...
          <div className="mt-4">
            <div className="box">
              <div>
                ...
                <h5 className="mt-2 pt-1 text-secondary fw-bold">
                  {data[0].basicInformation[0].businessName}
                </h5>
              </div>
              <div>
                <p className="m-0 text-primary fw-bold">Operator</p>
                <h5 className="mt-2 pt-1 text-secondary fw-bold">
                  {data[0].basicInformation[0].operator}
                </h5>
              </div>
              <div>
                <p className="m-0 text-primary fw-bold">Address</p>
                <h5 className="mt-2 pt-1 text-secondary fw-bold">
                  {data[0].basicInformation[0].address},{" "}
                  {data[0].basicInformation[0].city},{" "}
                  {data[0].basicInformation[0].zipCode}
                </h5>
              </div>
              <div>
                <p className="m-0 text-primary fw-bold">Phone Number</p>
                <h5 className="mt-2 pt-1 text-secondary fw-bold">
                  {data[0].basicInformation[0].phoneNumber}
                </h5>
              </div>
            </div>
          </div>
        ...
        <div className="mt-5 pt-4">
          ...
          <i>
            High Risk Factors are improper practices or procedures identified as
        ...
        <div className="mt-5 pt-4">
          ...
          <i>
            Low Risk Factors are preventive measures to control the addition of
            pathogens, chemicals, and physical objects into foods.
          </i>
          <hr></hr>
                      ...
                      (row: {
                        ...
                        return (
                          <div className="row my-2">
                            ...
                            <div className="col-5">{row.title}</div>
                            <div className="col-2">
                              {data[0].highRisk[questionNum2 - 1]
                                .repeatViolation && (
                                <input
                                  className="form-check-input"
                                  type="checkbox"
          ...
          <div className="mt-4">
            <div className="box">
              <div>
                ...
                {data[0].signatureRequestData.inspector.status ===
                  "Complete." && (
                  <div
                    style={{
                      borderRadius: "30px",
              ...
              <div>
                ...
                {data[0].signatureRequestData.client.status ===
                  "Incomplete." && (
                  <div
                    style={{
                      borderRadius: "30px",
